...
VALUES
  (
    ...
    'Mohammed',
    'El Shora',
    '$2y$10$9jVtGk3kxUYp9I9ZHsUFk.RFMSZqBBIBNEYM8wki5rR03sjzBr6D.',
    'email_password',
    '2024-02-01 13:51:51',
    '2024-02-01 01:53:48',
    NULL,
  ...
  (
    ...
    'Mohammed',
    'El Shora',
    '$2y$10$h.ulrppeGTTP/WW3mTOEoOR2SIWJswZpUJutj8Qmqw/8wtRjHQzoW',
    'email_password',
    '2024-02-01 02:16:35',
    '2024-02-01 02:16:16',
    NULL,
...
CREATE TABLE `group_deails` (
  ...
  `group_access_type` enum(
    'only_read',
    'read_write',
    'read_write_with_admin_permission'
  ) NOT NULL DEFAULT 'read_write_with_admin_permission',
...
ADD
  KEY `group_activity_ibfk_3` (`activity_owner_id`, `activity_group_id`),
ADD
  KEY `group_activity_ibfk_4` (`activity_group_id`, `activity_owner_id`),
ADD
  KEY `activity_direction_id` (`activity_direction_id`);

--
-- Indexes for table `group_activity_direction`
--
ALTER TABLE
  `group_activity_direction`
ADD
  PRIMARY KEY (`direction_id`),
ADD
  UNIQUE KEY `group_id` (`group_id`, `direction_address`),
ADD
  KEY `direction_in_direction_id` (`direction_in_direction_id`);
...
ADD
  KEY `group_deails_ibfk_1` (`group_owner_id`);
...
ALTER TABLE
  `payment_plan_time`
ADD
  PRIMARY KEY (`plan_time_id`),
ADD
  UNIQUE KEY `plan_id` (`plan_id`, `plan_time in months`);

--
-- Indexes for table `payment_purchase_data`
--
ALTER TABLE
  `payment_purchase_data`
ADD
  PRIMARY KEY (`purchase_id`),
ADD
  KEY `payment_purchase_data_ibfk_1` (`purchase_user_id`),
ADD
  KEY `payment_purchase_data_ibfk_2` (`purchase_plan_time_id`);
...
ALTER TABLE
  `payment_user_plan`
ADD
  PRIMARY KEY (`user_id`, `plan_time_id`),
ADD
  UNIQUE KEY `user_id` (`user_id`),
ADD
  UNIQUE KEY `purchase_data_id` (`purchase_data_id`),
ADD
  KEY `plan_time_id` (`plan_time_id`);
...
ADD
  UNIQUE KEY `user_id` (`verification_user`);
...
ALTER TABLE
  `payment_plan_time`
MODIFY
  `plan_time_id` int(11) NOT NULL AUTO_INCREMENT,
  AUTO_INCREMENT = 5;
...
ALTER TABLE
  `business_profiles`
ADD
  CONSTRAINT `business_profiles_ibfk_1` FOREIGN KEY (`business_user_id`) REFERENCES `app_users` (`user_id`) ON DELETE CASCADE;
...
ALTER TABLE
  `group_activity`
ADD
  CONSTRAINT `group_activity_ibfk_1` FOREIGN KEY (`activity_group_id`) REFERENCES `group_deails` (`group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD
  CONSTRAINT `group_activity_ibfk_3` FOREIGN KEY (`activity_owner_id`) REFERENCES `group_members` (`member_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
ADD
  CONSTRAINT `group_activity_ibfk_4` FOREIGN KEY (`activity_group_id`, `activity_owner_id`) REFERENCES `group_members` (`group_id`, `member_id`) ON DELETE NO ACTION ON UPDATE CASCADE,
ADD
  CONSTRAINT `group_activity_ibfk_5` FOREIGN KEY (`activity_direction_id`) REFERENCES `group_activity_direction` (`direction_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE
  `group_activity_direction`
ADD
  CONSTRAINT `group_activity_direction_ibfk_2` FOREIGN KEY (`direction_in_direction_id`) REFERENCES `group_activity_direction` (`direction_id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD
  CONSTRAINT `group_activity_direction_ibfk_3` FOREIGN KEY (`group_id`) REFERENCES `group_deails` (`group_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE
  `group_deails`
ADD
  CONSTRAINT `group_deails_ibfk_1` FOREIGN KEY (`group_owner_id`) REFERENCES `app_users` (`user_id`) ON UPDATE CASCADE;
...
ALTER TABLE
  `group_members`
ADD
  CONSTRAINT `group_members_ibfk_1` FOREIGN KEY (`group_id`) REFERENCES `group_deails` (`group_id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD
  CONSTRAINT `group_members_ibfk_2` FOREIGN KEY (`member_id`) REFERENCES `app_users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE
  `payment_plan_time`
ADD
  CONSTRAINT `payment_plan_time_ibfk_1` FOREIGN KEY (`plan_id`) REFERENCES `payment_plans` (`plan_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE
  `payment_purchase_data`
ADD
  CONSTRAINT `payment_purchase_data_ibfk_2` FOREIGN KEY (`purchase_plan_time_id`) REFERENCES `payment_plan_time` (`plan_time_id`) ON DELETE CASCADE ON UPDATE CASCADE;
...
ALTER TABLE
  `payment_user_plan`
ADD
  CONSTRAINT `payment_user_plan_ibfk_1` FOREIGN KEY (`user_id`) REFERENCES `app_users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD
  CONSTRAINT `payment_user_plan_ibfk_2` FOREIGN KEY (`plan_time_id`) REFERENCES `payment_plan_time` (`plan_time_id`) ON DELETE CASCADE ON UPDATE CASCADE,
ADD
  CONSTRAINT `payment_user_plan_ibfk_3` FOREIGN KEY (`purchase_data_id`) REFERENCES `payment_purchase_data` (`purchase_id`) ON DELETE NO ACTION ON UPDATE CASCADE;
...
ALTER TABLE
  `verification_codes`
ADD
  CONSTRAINT `verification_codes_ibfk_1` FOREIGN KEY (`verification_user`) REFERENCES `app_users` (`user_id`) ON DELETE CASCADE ON UPDATE CASCADE;
